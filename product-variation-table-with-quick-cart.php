 ...
 * @since 1.0.0
 */
function product_variation_table_with_quick_cart_check_conflicts() {
    $conflicting_plugins = [
        ...
        if (is_plugin_active($plugin)) {
            ...
            add_action('admin_notices', function() use ($plugin_name) {
                ...
                <div class="notice notice-error is-dismissible">
                    <p>
                        <strong><?php echo esc_html__('Product Variation Table with Quick Cart:', 'product-variation-table-with-quick-cart'); ?></strong>
                        <?php echo esc_html__(' This plugin cannot be activated because', 'product-variation-table-with-quick-cart'); ?>
                        <strong><?php echo esc_html($plugin_name); ?></strong>
                        <?php echo esc_html__(' is already active.', 'product-variation-table-with-quick-cart'); ?>
                        <br><br>
                        <?php echo esc_html__('Please deactivate it first and then try again.', 'product-variation-table-with-quick-cart'); ?>
                    </p>
                </div>
                <?php
            });
...
if (product_variation_table_with_quick_cart_check_conflicts() === true){
    return;
}else{
